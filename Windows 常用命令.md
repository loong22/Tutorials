...
Remove-Item (Get-PSReadlineOption).HistorySavePath  #清除Windows power shell命令记录

history -c  #GitBash清除历史记录
cat /dev/null >~/.bash_history 或者 > ~/.bash_history  #GitBash清除历史记录
...
```
清除代理服务器通常需要从以下几个方面进行操作：

1. 检查并关闭代理服务器设置：首先，打开操作系统的网络设置。在Windows系统中，可以通过“控制面板”>“网络和Internet”>“Internet选项”来打开。在Mac系统中，可以通过“系统偏好设置”>“网络”来打开。在网络设置中，找到“代理服务器”选项，确保其被禁用或关闭。如果有设置代理服务器的选项，将其清空或关闭。
    
2. 清除浏览器中的代理服务器设置：不同的浏览器有各自的设置界面，以下是对常见浏览器的代理服务器设置清除方法：
    
    - Google Chrome：点击右上角的菜单按钮，选择“设置”>“高级”>“打开代理设置”，在弹出的Internet属性窗口中的“连接”选项卡中将代理服务器设置清空或关闭。
    - Mozilla Firefox：点击右上角的菜单按钮，选择“选项”>“高级”>“网络”选项卡中的“设置”，在弹出的连接设置窗口中将代理服务器设置清空或关闭。
    - Microsoft Edge：点击右上角的菜单按钮，选择“设置”>“隐私、搜索和服务”>“网络设置”，在弹出的Internet属性窗口中的“连接”选项卡中将代理服务器设置清空或关闭。
    - Safari：点击菜单栏中的“Safari”>“偏好设置”>“高级”>“更改设置”按钮，在弹出的Internet属性窗口中的“连接”选项卡中将代理服务器设置清空或关闭。
3. 清除系统中的代理设置：有些应用程序或操作系统会在系统级别上进行代理设置。为了彻底清除代理服务器，需要检查并清除这些设置。
    
    - Windows系统：打开“控制面板”>“Internet选项”>“连接”选项卡中的“局域网设置”，将代理服务器设置清空或关闭。
    - Mac系统：打开“系统偏好设置”>“网络”>“高级”>“代理”选项卡，将代理服务器设置清空或关闭。
4. 清除其他应用程序中的代理设置：一些应用程序可能会有自己的代理设置，如网络下载工具、即时通讯工具等。请根据具体应用程序的设置选项，找到并清空代理服务器设置。
    
5. 扫描并清除恶意软件：有时代理服务器设置的改变是由恶意软件引起的。为了彻底清除代理服务器，需要使用防病毒软件或安全工具对系统进行全面扫描，并将发现的恶意软件移除。
    
6. 重启系统：最后一步是重启电脑。重启系统可以确保之前的操作生效并彻底清除代理服务器。在重启后，检查网络设置及浏览器设置，确认代理服务器已经彻底清除。
    

通过以上操作，可以彻底清除代理服务器设置，并确保网络连接无需经过代理服务器。
```
